        ...
        <div className="container custom_container py-md-5 mt-xl-3 mb-xl-5">
          <Row className="justify-content-between align-items-center">
            <Col lg={5} className="pb-3 pb-sm-0">
              ...
              <p className="color_dark_black fw-normal font_sm opacity_07 mb-0 pb-4 mb-sm-3">
              ...
              <div className="d-flex">
                ...
                <div className="ps-3 ms-1">
                  <h4 className="ff-gilroy-semibold fw-semibold color_dark_black font_sm mb-0">
                    Our Location
                  </h4>
                  <p className="color_dark_black fw-normal font_sm opacity_07 mb-0">
              ...
              <div className="d-flex py-sm-4 py-3">
                ...
                <div className="ps-3 ms-1">
                  ...
                  <a
                    ...
                    className="color_dark_black fw-normal font_sm opacity_07 mb-0"
                  >
            ...
            <Col lg={7} xl={6}>
              <form className="contact_form bg_light_blue">
                <p className="fw-normal color_dark_black font_sm">Are you a</p>
                <div className="d-flex">
                ...
                <div className="d-flex justify-content-between gap-sm-4 gap-1 pt-sm-3 mt-1 flex-column flex-sm-row">
                  <div className="w-100">
                    <p className="fw-normal color_dark_black font_sm mb-2">
                      First Name*
                    </p>
                ...
                <div>
                  <p className="fw-normal color_dark_black font_sm mb-2 pt-sm-3 mt-1">
                    I'm interested in
                  </p>
                  <Form.Select
                  ...
                  >
                    <option className="fw-normal color_dark_black font_sm">
                      Automotive window tint
                    </option>
                    <option
                      className="fw-normal color_dark_black font_sm"
                      value="1"
                    >
                      One
                    </option>
                ...
                <textarea className="w-100 fw-normal color_dark_black font_sm px-3"></textarea>
                <div className="d-flex align-items-center py-sm-4 my-2">
                  <input type="checkbox" />
                  <p className="fw-normal color_dark_black font_sm mb-0 ps-2">
